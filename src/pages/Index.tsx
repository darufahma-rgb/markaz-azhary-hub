    ...
    <main id="top" className="relative text-ivory overflow-x-hidden" style={{ backgroundColor: "hsl(var(--navy-deep))" }}>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-ivory/10 border border-ivory/10">
          {[
            { bg: "hsl(var(--navy-deep))", label: "On Navy", src: "/Markaz_Rabithah_Logo_1_1777345170344.png", textOnLight: false },
            { bg: "#B22222", label: "On Crimson", src: "/Logo_Markaz_Rabithah_on_crimson_1777348637704.png", textOnLight: false },
            { bg: "#F4EEE4", label: "On Ivory", src: "/Logo_Markaz_Rabithah_on_ivory_1777348637704.png", textOnLight: true },
          ].map((v) => (
            <div
              key={v.label}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-ivory/10 border-x border-b border-ivory/10">
          <div className="relative bg-background flex items-center justify-center p-8 md:p-12 aspect-[4/3] md:aspect-[2/1]">
            <img src="/Logo_Markaz_Rabithah_2_1777345186295.png" alt="Logo Mark" className="w-1/2 h-auto object-contain" />
          ...
          <div className="relative flex items-center justify-center p-8 md:p-12 aspect-[4/3] md:aspect-[2/1]" style={{ backgroundColor: "#F4EEE4" }}>
            <img src="/Logo_Markaz_Rabithah_2_1777345186295.png" alt="Logo Mark on Ivory" className="w-1/2 h-auto object-contain" />
